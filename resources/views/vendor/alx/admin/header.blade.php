                            ...
                            <ul>
                                <li>
                                    <a href="{{url('/admin/profile')}}">
                                        <i class="fa fa-edit fa-lg"></i><span class="m-left-xs">账号管理</span>
                                    </a>
                                </li>
                                <!--<li>
                                    <a href="{{url('/admin/inbox')}}">
            ...
            <ul class="nav-notification">
                    <li>
                        ...
                        <ul class="dropdown-menu message pull-right">
                            ...
                            <li>
                                <a class="clearfix" href="#">
                                    <img src="{{asset('images/profile/profile1.jpg')}}" alt="User Avatar">
                                    <div class="detail">
                        ...
                        <ul class="dropdown-menu notification dropdown-3 pull-right">
                            ...
                            <li>
                                <a href="#">
                                    ...
                                    <span class="m-left-xs">0 items sold.</span>

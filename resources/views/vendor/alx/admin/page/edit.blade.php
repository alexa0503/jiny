                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body pt0 pb0">
                                {{ Form::open(array('route' => ['page.update',$row->id], 'class'=>'form-horizontal group-border stripped', 'method'=>'PUT', 'id'=>'form')) }}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <input id="alias" type="text" name="alias" class="form-control" value="{{$row->alias}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <textarea class="form-control" name="desc" id="desc">{{$row->desc}}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <div class="row">
                                                <div class="col-lg-3 col-md-3"><input id="sort_id" type="text" name="sort_id" class="form-control" value="{{$row->sort_id}}"></div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-lg-10 col-md-9">
                                            <textarea class="form-control article-ckeditor" name="body" id="body">{!! $row->body !!}</textarea>
                                    ...
                                    <div class="form-group">
                                        <div class="col-lg-10 col-md-9 col-lg-offset-2 col-md-offset-3">
                                            ...
                                            <a class="btn btn-default ml15" href="{{route('page.index')}}">返回</a>
                                        </div>
                                    </div>
                                    {{ Form::close() }}
                            </div>
...
$(document).ready(function() {
    $('#menu_display').val('{{$row->menu_display}}');

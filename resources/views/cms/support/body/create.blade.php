        ...
        <div class="page-content-inner">
            ...
            <div id="page-header" class="clearfix">
                <div class="page-header">
                    <h2>@if($support->type_id == 1){{'技术资料'}}@else{{'样本下载'}}@endif - 编辑</h2>
                </div>
            </div>
            <!-- Start .row -->
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body pt0 pb0">
                            {{ Form::open(array('route' => ['support.body.store', Request::segment(3)], 'class'=>'form-horizontal group-border stripped', 'id'=>'form')) }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10 col-md-9">
                                    <textarea name="txt" class="form-control article-ckeditor" rows="6"></textarea>
